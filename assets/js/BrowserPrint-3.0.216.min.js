...
$jscomp.polyfill = function (b, h, c, e) {
  if (h) {
    ...
    h != e &&
      null != h &&
      $jscomp.defineProperty(c, b, { configurable: !0, writable: !0, value: h });
  }
};
$jscomp.polyfill(
...
var BrowserPrint = (function () {
  ...
  e.Device = function (a) {
    ...
    this.send = function (d, a, f) {
      ...
      g &&
        (void 0 !== m &&
          (void 0 === a && (a = m.sendFinishedCallback), void 0 === f && (f = m.sendErrorCallback)),
        c(g, a, f),
        g.send(
          JSON.stringify({
            device: {
    ...
    this.read = function (d, a) {
      ...
      f &&
        (void 0 !== m &&
          (void 0 === d && (d = m.readFinishedCallback), void 0 === a && (a = m.readErrorCallback)),
        c(f, d, a),
        f.send(
          JSON.stringify({
            device: {
  ...
  e.getLocalDevices = function (a, c, d) {
    ...
    g &&
      ((finishedFunction = function (b) {
        ...
        void 0 === d
          ? a(response)
          : (response.hasOwnProperty(d) || (response[d] = []), a(response[d]));
      }),
  ...
  e.getDefaultDevice = function (a, c, d) {
    ...
    if ((a = b("GET", l + g)))
      (finishedFunction = function (a) {
        ...
        "" === response
          ? c(null)
          : ((response = JSON.parse(response)), (a = new e.Device(response)), c(a));
      }),
