...
$jscomp.polyfill = function (e, h, g, l) {
  if (h) {
    ...
    h != l &&
      null != h &&
      $jscomp.defineProperty(g, e, { configurable: !0, writable: !0, value: h });
  }
};
...
$jscomp.polyfill(
  ...
  function (e) {
    ...
    c.prototype.settle_ = function (b, a) {
      if (0 != this.state_)
        throw Error(
          ("Cannot settle(" + b + ", " + a) | ("): Promise already settled in state" + this.state_)
        );
      this.state_ = b;
      this.result_ = a;
    ...
    c.race = function (b) {
      return new c(function (a, f) {
        for (var k = $jscomp.makeIterator(b), d = k.next(); !d.done; d = k.next())
          g(d.value).callWhenSettled_(a, f);
      });
    };
    c.all = function (b) {
  ...
  g.Printer = function (c) {
    ...
    g.Printer.Status = function (a) {
      ...
      h(a)
        ...
        : ((this.offline = !0),
          (this.ribbonOut = this.headOpen = this.paused = this.paperOut = !1));
    ...
    g.Printer.Configuration = function (a) {
      ...
      this.linkOSVersion = this.settings.hasOwnProperty("LINK-OS VERSION")
        ? this.settings["LINK-OS VERSION"]
        : "0";
    };
    var d = this;
    ...
    this.Request = function (a, f, b, c, e) {
      ...
      this.execute = function () {
        ...
        "info" == this.type || "config" == this.type || "status" == this.type
          ? d.sendThenReadUntilStringReceived(
              this.command,
    ...
    this.executeRequest = function () {
      ...
      0 < d.device_request_queue.length &&
        (dbg("Executing next request..."), d.device_request_queue[0].execute());
    };
